...
import com.payano.homeassistant.view.BubbleDrawable;
import com.payano.homeassistant.view.RotationLayout;
...
public class IconGenerator {
    ...
    public IconGenerator(Context context) {
        ...
        mTextView2 = (TextView) mRotationLayout.findViewById(R.id.amu_text2);
    ...
    public Bitmap makeMaterialIcon(CharSequence text) {
        if (mTextView2 != null) {
